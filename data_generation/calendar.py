    ...
    def add_api_calls(
        ...
        **kwargs
        ...
        for j in range(len(outputs)):
            ...
            outputs[j]["Generated"] = outputs[j]["generated_text"].split("Output:")[-1] ### generated text from the previous function 
            if "]" in outputs[j]["Calendar"]:
                ...
                outputs[j]["Calendar_text"] = "[Calendar()" ### pass empty calendar : API calling but no response 
                ...
                ### test inputs : executing `calendar` with self.calendar
